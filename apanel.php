...
<div class="alert alert-success alert-dismissible fade in">
        ...
        <font size="14"><strong><center><?php echo " ".$_SESSION['uname']." "; ?></center></strong></font>
    </div>
    <div class="bg-img">
<div class="container">
    <center><h1><font color="white" size="300"><b>ADMIN PANNEL</b></font></h1></center><hr></div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <center><a class="btn btn-secondary btn-secondary display-4" href="update2.php">Update Car</a></center>
        </div>
        <div class="col-sm-6">
...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
             <a class="btn" href="worker.php">Worker Operations</a>
        </div>  
         <div class="col-sm-4">
            <center><a class="btn1" href="logout.php" >Logout</a></center>
        </div>
         <div class="col-sm-4">
            <a class="btn" href="maintain3.html" style="float:right;">Car Maintainence</a>
        </div>
    </div>
</div>
    <?php
